...
mlflow.set_tracking_uri('https://dagshub.com/XzisT33/end_to_end_mlops_project.mlflow')  # Registry URI for model management

# Load the dataset from CSV file and split into training and testing sets
data = pd.read_csv("D:\MLOps\Data_Thinkers_MLOPS\end_to_end_mlops_project\data\water_potability.csv")
